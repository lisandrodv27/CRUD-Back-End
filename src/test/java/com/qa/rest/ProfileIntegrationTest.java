...
@Sql(scripts = { "classpath:profile-schema.sql",
		"classpath:profile-data.sql" }, executionPhase = ExecutionPhase.BEFORE_TEST_METHOD)
...
public class ProfileIntegrationTest {
	...
	void createProfileTest() throws Exception {
		...
		Profile savedProfile = new Profile("Julius Caesar", "Roman", "Famous Roman general");
